...
class TestView(TestCase):
    ...
    def test_post_list(self):
        ...
        main_area = soup.find('div', id='main-area')
        self.assetIn(post_001.title, main_area.text)
        self.assetIn(post_002.title, main_area.text)
        # 3.4 '아직 게시물이 없습니다'라는 문구는 더이상 보이지 않는다.
        self.assetIn('아직 게시물이 없습니다', main_area.text)
    ...
    def test_post_detail(self):
        ...
        #2.1. 첫전째 포스트의 url로 접근하면 정상적으로 작동한다.
